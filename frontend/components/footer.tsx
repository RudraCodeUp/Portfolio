      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-muted-foreground">Chandigarh, India</li>
              <li className="text-muted-foreground">Mariarudra82@gmail.com</li>
              <li className="text-muted-foreground">+91 9888484923</li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-border mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          >
            Made with <Heart className="w-4 h-4 mx-1 text-red-500" /> using Next.js and Three.js
          </motion.p>
        </div>
      </div>
    </footer>
